...
if(isset($_POST['update'])){
    ...
    $update_profile->execute([$name, $email, $customer_id]);
    ...
    if(!empty($image)){
       ...
       if($image_size > 2000000){
          ...
          $update_image->execute([$image, $customer_id]);
    ...
    if(!empty($previous_pass) || !empty($new_pass) || !empty($confirm_pass)){
       if($previous_pass != $old_pass){
          ...
          $update_password->execute([$confirm_pass, $customer_id]);
...
<head>
   ...
   <title>Customer Profile Ëdit</title>
...
<h1 class="title"> update <span>customer</span> profile </h1>
...
<section class="update-profile-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         ...
         <a href="customer.php" class="option-btn">go back</a>
      </div>
   </form>
