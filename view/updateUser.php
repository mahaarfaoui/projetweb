...
if (isset($_POST['user_id'])) {
    $user = $userC->listUsers($_POST['user_id']);
}
...
<form id="myf" action="" method="POST">
      <div class="input_box">
        <input type="text" placeholder="Username" name="username" id="usern" value="<?php echo $user['username']; ?>" >
        <div class="icon"><i class="fas fa-user"></i></div>
        <p  style="color : red; text-align:center; " id="error1"></p>
      </div>
      
      <div class="input_box">
        <input type="password" placeholder="Password" name="pw" id="pass"  value="<?php echo $user['password']; ?>">
        <div class="icon"><i class="fas fa-lock"></i></div>
        <p id="error2" style=" text-align:center;"> </p>
      </div>
      
      <div class="input_box">
        <input type="email" placeholder="example@gmail.com " name="em" id="emai"  value="<?php echo $user['email']; ?>">
    ...
    <select name="usertype" id="ch">
     ...
     <div class="input_boxx">
      ...
      <input type="file" name="image" id="f"  class="box"accept="image/jpg, image/jpeg, image/png" value="<?php echo $user['image']; ?>" >
</div>
