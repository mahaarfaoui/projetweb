...
$db = connect::getConnexion();  
  $select_profile = $db->prepare("SELECT * FROM `user` WHERE user_type = ?");
  $select_profile->execute(['employee']);
  $fetch_profile = $select_profile->fetchAll();
...
<a href="listcustomers.php" style="text-decoration:none;"> <div class="card">
    ...
    <table border="1" align="center" width="70%">
        ...
        <?php
        foreach ($fetch_profile as $profile) {
        ?>
            ...
            <tr>
                ...
                <td align="center"><?= $profile['password']; ?></td>
                <td align="center"><img class="user"src="../assets/images/<?= $profile['image']; ?>" alt=""> </td>
               
                <td align="center">
                    <a class="btn"href="deleteUser.php?user_id=<?php echo $profile['user_id']; ?>">Delete Employee</a>
                    
                   <!-- <div> <ion-icon name="person-remove-outline"></ion-icon></div>-->
                </td>
    ...
    <br>
    <div align="center">
                <a class="btn" href="addUser.php?id=<?php echo $profile['user_id']; ?>">
                    <i class="iconBx">
